    ...
    public class TouchEffect : PlatformEffect
    {
        ...
        protected override void OnAttached()
        {
            ...
            if (touchEffect != null && view != null)
            {
                ...
                view.Touch += OnTouch;
                System.Diagnostics.Debug.WriteLine("Attaching OnTouch() to view.Touch");
            }
        }
        ...
        protected override void OnDetached()
        {
            if (viewDictionary.ContainsKey(view))
            {
                ...
                view.Touch -= OnTouch;
                System.Diagnostics.Debug.WriteLine("Deattaching OnTouch() from view.Touch");
            }
        }
        ...
        void OnTouch(object sender, Android.Views.View.TouchEventArgs args)
        {
            ...
            System.Diagnostics.Debug.WriteLine("OnTouch: " + args.Event.Action.ToString() + ": " + args.Event.ActionMasked.ToString() + ": " 
        ...
        {
            System.Diagnostics.Debug.WriteLine("FireEvent: " + actionType.ToString());
